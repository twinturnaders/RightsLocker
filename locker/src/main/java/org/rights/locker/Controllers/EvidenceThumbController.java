// src/main/java/org/rights/locker/Controllers/EvidenceThumbController.java
...
public class EvidenceThumbController {
    ...
    public ResponseEntity<byte[]> thumbnail(@RequestParam(required=false) UUID id,
        ...
        if (k == null || k.isBlank()) return ResponseEntity.notFound().build();
